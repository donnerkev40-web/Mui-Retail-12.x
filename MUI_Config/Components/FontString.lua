...
function Components.fontstring(parent, config)
  ...
  row.content = row:CreateFontString(nil, "ARTWORK", "MUI_ConfigFont")--[[@as FontString]];
  ...
  container.content = container:CreateFontString(nil, "ARTWORK", "MUI_ConfigFont")--[[@as FontString]];
    ...
    if (config.subtype == "header") then
      container.content:SetFontObject("MUI_ConfigFontLarge");
    elseif (config.subtype == "sub-header") then
      container.content:SetFontObject("MUI_ConfigFontSmall");
