...
function Components.title(parent, config)
  ...
  container.title = container:CreateFontString(nil, "OVERLAY", "MUI_ConfigFontLarge");
  tk:SetFontSize(container.title, 14);

  if (config.description) then
    container.description = container:CreateFontString(nil, "OVERLAY", "MUI_ConfigFontSmall");
