...
setup.import["ShadowedUnitFrames"] = function(selectedLayout)
  local settings = {
["namespaces"] = {
},
["global"] = {
...
["r"] = 1,
  ...
  _G.ShadowedUFDB = _G.ShadowedUFDB or {};
  _G.ShadowedUFDB.profiles = _G.ShadowedUFDB.profiles or {};

  local targetProfileName = "MayronUI-DPS";
  if (selectedLayout == "Healer") then
    targetProfileName = "MayronUI-Heal";
  end

  local selectedProfile;
  if (settings.profiles and settings.profiles[targetProfileName]) then
    selectedProfile = settings.profiles[targetProfileName];
  end

  settings.profiles = nil;
  MergeTables(_G.ShadowedUFDB, settings);

  if (selectedProfile) then
    _G.ShadowedUFDB.profiles[targetProfileName] = _G.ShadowedUFDB.profiles[targetProfileName] or {};
    MergeTables(_G.ShadowedUFDB.profiles[targetProfileName], selectedProfile);
  end
