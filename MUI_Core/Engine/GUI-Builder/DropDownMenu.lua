...
local function GetDropDownFontObject(frame)
...
function DropDownMenu:__Construct(data, header, direction, slideController, frame)
  ...
  data.label = data.header:CreateFontString(nil, "OVERLAY", GetDropDownFontObject(data.frame));
...
function DropDownMenu:AddOption(data, label, func, ...)
  ...
  option:SetNormalFontObject(GetDropDownFontObject(data.frame));
