...
L["PVP"] = "PVP";
L["Store"] = "Store";
L["Player Spells"] = "Spells & Talents";
L["Spell Book"] = "Spell Book";
L["Talents"] = "Talents";
L["Achievements"] = "Achievements";
L["Glyphs"] = "Glyphs";
L["Calendar"] = "Calendar";
L["Calendar Icon"] = "Calendar Icon";
L["Battlefield Icon"] = "Battlefield Icon";
...
L["Open Guild & Communities"] = "Open Guild & Communities";
L["Quests"] = "Quests";
...
L["Fonts"] = "Fonts";
L["Blizzard Font"] = "Blizzard Font";
L["MUI Font"] = "MUI Font";
L["Combat Text Font"] = "Combat Text Font";
L["Changing combat text fonts requires a full client restart."] = "Changing combat text fonts requires a full client restart.";
L["External addon font changes are written to the currently active profile."] = "External addon font changes are written to the currently active profile.";
L["Backdrop Inset"] = "Backdrop Inset";
L["Chat Frame Options"] = "Chat Frame Options";
L["Enable Chat Frame"] = "Enable Chat Frame";
L["Enable Window"] = "Enable Window";
L["Window"] = "Window";
L["Window Options"] = "Window Options";
L["Window Type"] = "Window Type";
L["Empty"] = "Empty";
L["Action"] = "Action";
...
L["These settings control the three shortcut buttons on the active main chat window."] =
  "These settings control the three shortcut buttons on the active main chat window.";
L["Universal Window"] = "Universal Window";
L["Universal Window with Icons"] = "Universal Window with Icons";
L["Chat Window with Icons"] = "Chat Window with Icons";
L["All Objectives"] = "All Objectives";
L["Damage Meter"] = "Damage Meter";
L["This slot is disabled. Set a window type to use it."] =
  "This slot is disabled. Set a window type to use it.";
L["Action windows currently use the MUI shell only. Content will be added later."] =
  "Universal windows embed Kaliel's Tracker, MoneyLooter, Zygor Guides, or the Blizzard damage meter and switch them through the vertical side icons.";
L["Only 1 active window of the selected type can show the side icons on the sidebar (see icons listed below)."] =
  "Only 1 active window of the selected type can show the side icons on the sidebar (see icons listed below).";
L["This option affects all active chat and universal windows. Configure each window below."] =
  "This option affects all active chat and universal windows. Configure each window below.";
L["Select which window the side icons should be anchored to."] =
  "Select which window the side icons should be anchored to.";
L["Cell will only appear in raids or groups with more than 5 players."] =
  "Cell will only appear in raids or groups with more than 5 players.";
L["Chat"] = "Chat";
L["Kaliel's Tracker"] = "Kaliel's Tracker";
L["Toggle Kaliel's Tracker"] = "Toggle Kaliel's Tracker";
L["MoneyLooter"] = "MoneyLooter";
L["Toggle MoneyLooter"] = "Toggle MoneyLooter";
L["Damage Meter"] = "Damage Meter";
L["Toggle Damage Meter"] = "Toggle Damage Meter";
L["Zygor Guides"] = "Zygor Guides";
L["Toggle Zygor Guides"] = "Toggle Zygor Guides";
L["Options"] = "Options";
...
L["Theme"] = "Theme";
L["External AddOns"] = "External AddOns";
L["SUF Font"] = "SUF Font";
L["SUF Font Size"] = "SUF Font Size";
L["Bartender Font"] = "Bartender Font";
...
L["Each layout now maps to a full MayronUI profile plus the assigned external addon profiles. Manage which addon profiles should switch with each layout, and create or maintain your layout set here."] =
  "Each layout now maps to a full MayronUI profile plus the assigned external addon profiles. Manage which addon profiles should switch with each layout, and create or maintain your layout set here.";
L["Up"] = "Up";
L["Down"] = "Down";
...
L["Enable Portraits"] = "Enable Portraits";
L["Enable Portrait Gradient"] = "Enable Portrait Gradient";
L["Opacity"] = "Opacity";
L["TT_MUI_ENABLE_SUF_PORTRAITS"] =
  "Enable or disable the Shadowed Unit Frames portraits for both the player and target frames together.";
...
L["Performance Overview"] = "Performance Overview";
L["Memory"] = "Memory";
L["Total AddOn Memory"] = "Total AddOn Memory";
L["Lua Memory"] = "Lua Memory";
L["Total AddOn CPU"] = "Total AddOn CPU";
L["Top Memory AddOns"] = "Top Memory AddOns";
L["Top CPU AddOns"] = "Top CPU AddOns";
L["CPU Profiling Disabled"] = "CPU profiling disabled (scriptProfile off)";
L["FPS"] = "FPS";
L["Home"] = "Home";
L["Server"] = "Server";
...
L["These settings only apply when MUI is allowed to manage Shadowed Unit Frames."] =
  "These settings only apply when MUI is allowed to manage Shadowed Unit Frames.";
L["These options style the MUI background panels. Use the Bartender4 tab for the external action bars themselves."] =
  "These options style the MUI background panels. Use the Bartender4 tab for the external action bars themselves.";
L["These options style the MUI unit background panels. Use the SUF tab for external Shadowed Unit Frames."] =
  "These options style the MUI unit background panels. Use the SUF tab for external Shadowed Unit Frames.";
...
L["The frame strata of the entire Info Panel bar."] = "The frame strata of the entire Info Panel bar.";
...
L["The font size of text that appears on Info Panel buttons."] =
  "The font size of text that appears on Info Panel buttons.";
...
L["The frame level of the entire Info Panel bar based on its frame strata value."] =
  "The frame level of the entire Info Panel bar based on its frame strata value.";
...
L["If unchecked, the entire Info Panel will be disabled and all"] =
  "If unchecked, the entire Info Panel will be disabled and all";
L["Info Panel buttons, as well as the background bar, will not be displayed."] =
  "Info Panel buttons, as well as the background bar, will not be displayed.";
L["Info Panel"] = "Info Panel";
L["Info Panel Modules"] = "Info Panel Modules";
L["You can always install presets at any time from the MayronUI installer."] = "You can always install presets at any time from the MayronUI installer.";
...
L["Action Windows"] = "Action Windows";
L["Mini-Map Options"] = "Mini-Map Options";
L["Mini-Map"] = "Mini-Map";
L["Text Widgets"] = "Text Widgets";
L["Icon Widgets"] = "Icon Widgets";
L["These settings control the Minimap itself and its global behavior."] = "These settings control the Minimap itself and its global behavior.";
L["These options control text shown around the Minimap."] = "These options control text shown around the Minimap.";
L["These options control the icons attached to the Minimap."] = "These options control the icons attached to the Minimap.";
L["These settings control the Minimap itself and its global behavior."] =
  "These settings control the Minimap itself and its global behavior.";
L["These options control text shown around the Minimap."] =
  "These options control text shown around the Minimap.";
L["These options control the icons attached to the Minimap."] =
  "These options control the icons attached to the Minimap.";
...
L["Installer Theme Header"] = "Theme";
L["Installer Layout Header"] = "Starting Layout";
L["Installer Options Header"] = "Installation Options";
L["Installer Quick Start"] = "Quick Start";
L["Installer Quick Start Description"] = "MayronUI creates only the selected layout profile for this character and automatically assigns the supported addon profiles.";
L["Installer Minimal Summary"] = "The safe minimal state stays active after installation. We then enable MUI in controlled steps, one module at a time.";
L["Installer Secondary Layout Hint"] = "The second layout profile will only be created later when you actually switch to that layout.";
L["Hint"] = "Hint";
...
L["These settings control the experience and reputation bars shown around the main action bar area."] = "These settings control the experience and reputation bars shown around the main action bar area.";
...
L["Chat Frame with Icons"] = "Window with Icons";
...
L["Action Buttons"] = "Action Buttons";
L["Masque Style"] = "Masque Style";
L["Choose the Masque skin used for the Bartender4 action buttons."] = "Choose the Masque skin used for the Bartender4 action buttons.";
...
L["Reset Zoom Delay"] = "Reset Zoom Delay";
L["This button opens the most relevant expansion feature or mission interface available for your character on Retail."] =
  "This button opens the most relevant expansion feature or mission interface available for your character on Retail.";
...
L["Hide Blizzard Cast Bars"] = "Hide Blizzard Cast Bars";
...
L["If checked, the default Blizzard cast bars will be hidden while MayronUI cast bars are active."] =
  "If checked, the default Blizzard cast bars will be hidden while MayronUI cast bars are active.";
...
L["These settings control the main chat window and its general behavior."] = "These settings control the main chat window and its general behavior.";
L["These settings control highlighted text and custom chat channel aliases."] = "These settings control highlighted text and custom chat channel aliases.";
L["These settings control the vertical sidebar icons attached to the chat window."] = "These settings control the vertical sidebar icons attached to the chat window.";
L["These icons belong to the main chat window and are shown vertically on its sidebar."] = "These icons belong to the main chat window and are shown vertically on its sidebar.";
L["These settings control the active MUI chat window and its fixed layout."] = "These settings control the active MUI chat window and its fixed layout.";
L["These settings control the cast bar module itself and shared behavior."] = "These settings control the cast bar module itself and shared behavior.";
L["These settings control the shared look of all MayronUI cast bars."] = "These settings control the shared look of all MayronUI cast bars.";
L["These settings control each individual cast bar separately."] = "These settings control each individual cast bar separately.";
...
L["Cannot delete managed layout profiles."] = "Cannot delete managed layout profiles.";
...
L["These settings only affect the Bartender4 action bars, not the MUI panels themselves."] =
  "These settings only affect the Bartender4 action bars, not the MUI panels themselves.";
...
L["Control Bartender Positioning"] = "Control Bartender Positioning";
L["Override Bartender Padding"] = "Override Bartender Padding";
...
L["Override Bartender Scale"] = "Override Bartender Scale";
...
L["Prevent the inventory frame from being moved."] = "Prevent the inventory frame from being moved.";
...
L["Delete selected profile (cannot delete the 'Default' or layout-managed profiles)."] = "Delete selected profile (cannot delete the 'Default' or layout-managed profiles).";
L["You can always install presets at anytime from the custom install tab located on the MayronUI installer."] = "You can always install presets at any time from the MayronUI installer.";
L["The frame strata of the entire Info Panel bar."] = "The frame strata of the entire Info Panel bar.";
L["The frame level of the entire Info Panel bar based on its frame strata value."] = "The frame level of the entire Info Panel bar based on its frame strata value.";
L["If unchecked, the entire Info Panel will be disabled and all"] = "If unchecked, the entire Info Panel will be disabled and all";
L["Info Panel buttons, as well as the background bar, will not be displayed."] = "Info Panel buttons, as well as the background bar, will not be displayed.";
L["The font size of text that appears on Info Panel buttons."] = "The font size of text that appears on Info Panel buttons.";
L["Info Panel"] = "Info Panel";
L["Info Panel Modules"] = "Info Panel Modules";
