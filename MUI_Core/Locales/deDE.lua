...
L["PVP"] = "PVP";
L["Store"] = "Shop";
L["Player Spells"] = "Zauber & Talente";
L["Spell Book"] = "Zauber Buch";
L["Talents"] = "Talente";
L["Achievements"] = "Erfolge";
L["Glyphs"] = "Glyphen";
L["Calendar"] = "Kalender";
L["Calendar Icon"] = "Kalendersymbol";
L["Battlefield Icon"] = "Schlachtfeldsymbol";
...
L["Open Guild & Communities"] = "Gilde & Communitys öffnen";
L["Quests"] = "Quests";
...
L["Blizzard Font"] = "Blizzard-Schriftart";
L["MUI Font"] = "MUI-Schriftart";
L["Combat Text Font"] = "Kampftext-Schriftart";
L["Changing combat text fonts requires a full client restart."] = "Das Ändern der Kampftext-Schriftarten erfordert einen vollständigen Client-Neustart.";
L["External addon font changes are written to the currently active profile."] = "Änderungen an externen AddOn-Schriftarten werden in das aktuell aktive Profil geschrieben.";
...
L["Enable Window"] = "Fenster aktivieren";
L["Window"] = "Fenster";
L["Window Options"] = "Fenster-Einstellungen";
L["Window Type"] = "Fenstertyp";
L["Empty"] = "Leer";
L["Action"] = "Action";
L["Chat Window"] = "Chat-Fenster";
L["Chat Buttons"] = "Chat-Schaltflächen";
L["These settings control the three shortcut buttons on the active main chat window."] =
  "Diese Einstellungen steuern die drei Schnellzugriffs-Schaltflächen des aktiven Hauptchatfensters.";
L["Universal Window"] = "Universal-Fenster";
L["Universal Window with Icons"] = "Universal-Fenster mit Symbolen";
L["Chat Window with Icons"] = "Chat-Fenster mit Symbolen";
L["All Objectives"] = "Alle Ziele";
L["Damage Meter"] = "Schadensanzeige";
L["This slot is disabled. Set a window type to use it."] =
  "Dieser Platzhalter ist deaktiviert. Wählen Sie einen Fenstertyp, um ihn zu verwenden.";
L["Action windows currently use the MUI shell only. Content will be added later."] =
  "Universal-Fenster wechseln ihren eingebetteten Inhalt über die vertikalen Seitensymbole.";
L["Only 1 active window of the selected type can show the side icons on the sidebar (see icons listed below)."] =
  "Nur 1 aktives Fenster des gewählten Typs kann die Seitensymbole anzeigen (siehe Symbole unten).";
L["Select which window the side icons should be anchored to."] =
  "Wählen Sie, an welches Fenster die Seitensymbole verankert werden sollen.";
L["Cell will only appear in raids or groups with more than 5 players."] =
  "Cell erscheint nur in Schlachtzügen oder Gruppen mit mehr als 5 Spielern.";
L["Chat"] = "Chat";
L["Kaliel's Tracker"] = "Kaliel's Tracker";
L["Toggle Kaliel's Tracker"] = "Kaliel's Tracker umschalten";
L["MoneyLooter"] = "MoneyLooter";
L["Toggle MoneyLooter"] = "MoneyLooter umschalten";
L["Damage Meter"] = "Schadensanzeige";
L["Toggle Damage Meter"] = "Schadensanzeige umschalten";
L["Zygor Guides"] = "Zygor Guides";
L["Toggle Zygor Guides"] = "Zygor Guides umschalten";
L["This option affects all active chat and universal windows. Configure each window below."] =
  "Diese Option betrifft alle aktiven Chat- und Universal-Fenster. Konfigurieren Sie die einzelnen Fenster unten.";
L["Action windows currently use the MUI shell only. Content will be added later."] =
  "Universal-Fenster binden Kaliel's Tracker, MoneyLooter, Zygor Guides oder die Blizzard-Schadensanzeige ein und schalten sie uber die vertikalen Seitensymbole um.";
...
L["Theme"] = "Thema";
L["External AddOns"] = "Externe AddOns";
L["SUF Font"] = "SUF-Schrift";
L["SUF Font Size"] = "SUF-Schriftgröße";
L["Bartender Font"] = "Bartender-Schrift";
...
L["Each layout now maps to a full MayronUI profile plus the assigned external addon profiles. Manage which addon profiles should switch with each layout, and create or maintain your layout set here."] =
"Jedes Layout verweist jetzt auf ein vollständiges MayronUI-Profil plus die zugewiesenen externen AddOn-Profile. Lege hier fest, welche AddOn-Profile pro Layout wechseln sollen, und verwalte oder erstelle deine Layouts.";
L["General"] = "Allgemein";
...
L["Enable Portraits"] = "Portraits aktivieren";
L["Enable Portrait Gradient"] = "Portrait-Farbverlauf aktivieren";
L["Opacity"] = "Deckkraft";
L["TT_MUI_ENABLE_SUF_PORTRAITS"] =
  "Aktiviert oder deaktiviert die Shadowed Unit Frames Portraits fuer Spieler und Ziel gemeinsam.";
...
L["Performance Overview"] = "Performance Übersicht";
L["Memory"] = "Arbeitsspeicher";
L["Total AddOn Memory"] = "Gesamter AddOn Speicher";
L["Lua Memory"] = "Lua Speicher";
L["Total AddOn CPU"] = "Gesamte AddOn CPU";
L["Top Memory AddOns"] = "Top AddOns nach Speicher";
L["Top CPU AddOns"] = "Top AddOns nach CPU";
L["CPU Profiling Disabled"] = "CPU-Profiling deaktiviert (scriptProfile aus)";
L["FPS"] = "FPS";
L["Home"] = "Home";
L["Server"] = "Server";
...
L["Allow MUI to Control Unit Frames"] = "Shadowed Unit Frames durch MUI steuern";
L["These settings only apply when MUI is allowed to manage Shadowed Unit Frames."] =
  "Diese Einstellungen greifen nur, wenn MUI Shadowed Unit Frames verwalten darf.";
L["These options style the MUI background panels. Use the Bartender4 tab for the external action bars themselves."] =
  "Diese Optionen gestalten die MUI-Hintergrundpaneele. Nutze den Bartender4-Tab für die externen Aktionsleisten selbst.";
L["These options style the MUI unit background panels. Use the SUF tab for external Shadowed Unit Frames."] =
  "Diese Optionen gestalten die MUI-Hintergrundpaneele der Einheiten. Nutze den SUF-Tab für externe Shadowed Unit Frames.";
...
L["Chat Frames"] = "Chatfenster";
L["Action Windows"] = "Action Fenster";
L["Mini-Map Options"] = "Minikartenoptionen";
L["Mini-Map"] = "Minikarte";
L["Text Widgets"] = "Text-Widgets";
L["Icon Widgets"] = "Icon-Widgets";
L["These settings control the Minimap itself and its global behavior."] = "Diese Einstellungen steuern die Minikarte selbst und ihr allgemeines Verhalten.";
L["These options control text shown around the Minimap."] = "Diese Einstellungen steuern die Texte rund um die Minikarte.";
L["These options control the icons attached to the Minimap."] = "Diese Einstellungen steuern die Symbole an der Minikarte.";
L["These settings control the Minimap itself and its global behavior."] =
  "Diese Einstellungen steuern die Minikarte selbst und ihr globales Verhalten.";
L["These options control text shown around the Minimap."] =
  "Diese Optionen steuern Texte, die rund um die Minikarte angezeigt werden.";
L["These options control the icons attached to the Minimap."] =
  "Diese Optionen steuern die Symbole, die an der Minikarte hängen.";
...
L["Installer Theme Header"] = "Thema";
L["Installer Layout Header"] = "Startlayout";
L["Installer Options Header"] = "Installationsoptionen";
L["Installer Quick Start"] = "Schnellstart";
L["Installer Quick Start Description"] = "MayronUI erstellt für diesen Charakter nur das ausgewählte Layoutprofil und weist die unterstützten AddOn-Profile automatisch zu.";
L["Installer Minimal Summary"] = "Der sichere Minimalzustand bleibt nach der Installation aktiv. Danach schalten wir MUI kontrolliert Modul für Modul frei.";
L["Installer Secondary Layout Hint"] = "Das zweite Layoutprofil wird erst erstellt, wenn du später wirklich auf dieses Layout wechselst.";
L["Hint"] = "Hinweis";
...
L["These settings control the experience and reputation bars shown around the main action bar area."] = "Diese Einstellungen steuern die Erfahrungs- und Rufleisten rund um den Hauptbereich der Aktionsleisten.";
...
L["Expansion Features"] = "Erweiterungsfunktionen";
...
L["Chat Frame with Icons"] = "Fenster mit Symbolen";
...
L["Action Buttons"] = "Aktionsbuttons";
L["Masque Style"] = "Masque-Stil";
L["Choose the Masque skin used for the Bartender4 action buttons."] = "Wähle den Masque-Stil für die Bartender4-Aktionsbuttons.";
...
L["Looking For Group Icon"] = "Gruppensuche-Symbol";
L["New Mail Icon"] = "Neues Postsymbol";
L["Missions Icon"] = "Missionssymbol";
L["Reset Zoom"] = "Zoom zurücksetzen";
L["Reset Zoom Delay"] = "Verzögerung beim Zoom-Reset";
L["This button opens the most relevant expansion feature or mission interface available for your character on Retail."] =
  "Diese Schaltfläche öffnet auf Retail die passendste Erweiterungs- oder Missionsoberfläche für deinen Charakter.";
L["Tracking Icon"] = "Verfolgungssymbol";
...
L["Hide Blizzard Cast Bars"] = "Blizzard-Zauberleisten ausblenden";
L["Show Spell Name"] = "Zaubername anzeigen";
L["If checked, the default Blizzard cast bars will be hidden while MayronUI cast bars are active."] =
  "Wenn aktiviert, werden die standardmäßigen Blizzard-Zauberleisten ausgeblendet, solange die MayronUI-Zauberleisten aktiv sind.";
...
L["These settings control the main chat window and its general behavior."] = "Diese Einstellungen steuern das Haupt-Chatfenster und sein allgemeines Verhalten.";
L["These settings control highlighted text and custom chat channel aliases."] = "Diese Einstellungen steuern hervorgehobene Texte und eigene Aliasnamen für Chatkanäle.";
L["These settings control the vertical sidebar icons attached to the chat window."] = "Diese Einstellungen steuern die vertikalen Seitensymbole am Chatfenster.";
L["These icons belong to the main chat window and are shown vertically on its sidebar."] = "Diese Symbole gehören zum Haupt-Chatfenster und werden vertikal an seiner Seitenleiste angezeigt.";
L["These settings control the active MUI chat window and its fixed layout."] = "Diese Einstellungen steuern das aktive MUI-Chatfenster und sein festes Layout.";
L["These settings control the cast bar module itself and shared behavior."] = "Diese Einstellungen steuern das Zauberleisten-Modul selbst und sein gemeinsames Verhalten.";
L["These settings control the shared look of all MayronUI cast bars."] = "Diese Einstellungen steuern das gemeinsame Aussehen aller MayronUI-Zauberleisten.";
L["These settings control each individual cast bar separately."] = "Diese Einstellungen steuern jede einzelne Zauberleiste separat.";
...
L["Cannot delete managed layout profiles."] =
  "Layoutverwaltete Profile können nicht gelöscht werden.";
...
L["These settings only affect the Bartender4 action bars, not the MUI panels themselves."] =
  "Diese Einstellungen betreffen nur die Bartender4-Aktionsleisten, nicht die MUI-Panels selbst.";
...
L["Control Bartender Positioning"] = "Bartender-Positionierung steuern";
L["Override Bartender Padding"] = "Bartender-Abstand überschreiben";
...
L["Override Bartender Scale"] = "Bartender-Skalierung überschreiben";
...
L["Prevent the inventory frame from being moved."] = "Verhindert, dass der Inventarrahmen verschoben werden kann.";
...
L["Delete selected profile (cannot delete the 'Default' or layout-managed profiles)."] = "Ausgewähltes Profil löschen (Standard- und layoutverwaltete Profile können nicht gelöscht werden).";
L["You can always install presets at anytime from the custom install tab located on the MayronUI installer."] = "Sie können Voreinstellungen jederzeit über den MayronUI-Installer installieren.";
L["The frame strata of the entire Info Panel bar."] = "Die Darstellungsschicht der gesamten Info-Panel-Leiste.";
L["The frame level of the entire Info Panel bar based on its frame strata value."] = "Die Darstellungsebene der gesamten Info-Panel-Leiste basierend auf ihrer Darstellungsschicht.";
L["If unchecked, the entire Info Panel will be disabled and all"] = "Wenn deaktiviert, wird das gesamte Info Panel ausgeblendet und alle";
L["Info Panel buttons, as well as the background bar, will not be displayed."] = "Info-Panel-Schaltflächen sowie die Hintergrundleiste werden nicht angezeigt.";
L["The font size of text that appears on Info Panel buttons."] = "Die Schriftgröße des Textes auf den Info-Panel-Schaltflächen.";
L["Info Panel"] = "Info Panel";
L["Info Panel Modules"] = "Info Panel-Module";
L["You can always install presets at any time from the MayronUI installer."] = "Sie können Voreinstellungen jederzeit über den MayronUI-Installer installieren.";
