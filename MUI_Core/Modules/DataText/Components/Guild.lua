...
local function OpenGuildAndCommunities()
  if (tk:IsRetail()) then
    if (obj:IsFunction(_G.ToggleGuildFrame)) then
      _G.ToggleGuildFrame();
      return;
    end

    if (obj:IsFunction(_G.ToggleCommunitiesFrame)) then
...
local function ButtonOnEnter(self)
  ...
  GameTooltip:AddDoubleLine(tk.Strings:SetTextColorByTheme(L["Right Click:"]), L["Open Guild & Communities"], r, g, b, 1, 1, 1);
  GameTooltip:Show();
end
